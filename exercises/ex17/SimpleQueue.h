 ...
 */
 ...
 class SimpleQueue {
  ...
  private:
   ...
   int size;
   // mutable so even when it comes to a const class like Size(), we can still
   // change the state of the mutex lock.
   mutable pthread_mutex_t mutex;  // add a pthread mutex lock
 };  // class SimpleQueue
